  ...
  return (
    <section className="relative flex flex-col justify-center items-center overflow-hidden bg-black w-full lg:h-screen p-4">
      <header className="relative w-full border-b border-secondary/10 mb-2 h-20 lg:h-auto">
        <img src={logo} alt="Logo" width={100} height={100} className="rounded-md absolute lg:-top-23 -top-5" />
      </header>
      ...
      <div className="container relative z-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mb-10 text-md text-muted">
            Convert all your tokens, including dust, into a single asset instantly. Save time, reduce fees, and simplify
            your crypto experience on Solana.
          </p>
